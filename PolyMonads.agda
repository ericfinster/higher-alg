...
module PolyMonads where
  ...
  module _ {I : Type₀} (M : Mnd I) where
    ...
    -- μρ-η-slc {c = box c δ ε} κ q | inl q₀ = {!!}
    -- μρ-η-slc {c = box c δ ε} κ q | inr (p , q₀) = {!!}

    -- I seem to need to use the fact that, in my chosen branch, we have
    --
    --  slc-graft-ρ-from (κ (inl unit)) δ (λ q₀ → μ-slc (ε q₀) (λ q₁ → κ (inr (q₀ , q₁)))) q == inl q₀
    --

    -- But this information disappears when I use the with matching.
    -- How do I reover it?
    --
